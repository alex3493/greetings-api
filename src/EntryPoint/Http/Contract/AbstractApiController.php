...
use App\Modules\Shared\Domain\Exception\BadRequestDomainException;
...
class AbstractApiController extends AbstractController
{
    ...
    public function __construct(LoggerInterface $logger, SerializerInterface $serializer, ValidatorInterface $validator)
    {
        $this->logger = $logger;
